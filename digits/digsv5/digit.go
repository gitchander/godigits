...
// Digit Sasha
type DigitSasha struct{}

var _ dgdr.DigitDrawer = DigitSasha{}

func (DigitSasha) Width(height float64) (width float64) {
	width = height / 2
	return
}

func (d DigitSasha) DrawDigit(c *gg.Context, x0, y0 float64, digitHeight float64, digit int) {
